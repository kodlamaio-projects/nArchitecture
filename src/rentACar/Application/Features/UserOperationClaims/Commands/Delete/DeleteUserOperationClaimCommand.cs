...
public class DeleteUserOperationClaimCommand : IRequest<DeletedUserOperationClaimResponse>, ISecuredRequest
{
    ...
    public string[] Roles => new[] { Domain.Constants.OperationClaims.Admin, UserOperationClaimsOperationClaims.Admin, Write, UserOperationClaimsOperationClaims.Delete };

    public class
        DeleteUserOperationClaimCommandHandler : IRequestHandler<DeleteUserOperationClaimCommand,
            DeletedUserOperationClaimResponse>
    {
                                                               ...
                                                               CancellationToken cancellationToken)
        {
            ...
            DeletedUserOperationClaimResponse deletedUserOperationClaimDto =
                _mapper.Map<DeletedUserOperationClaimResponse>(deletedUserOperationClaim);
