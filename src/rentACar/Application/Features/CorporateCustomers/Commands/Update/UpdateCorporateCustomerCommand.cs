...
public class UpdateCorporateCustomerCommand : IRequest<UpdatedCorporateCustomerResponse>, ISecuredRequest
{
    ...
    public string[] Roles => new[] { Domain.Constants.OperationClaims.Admin, CorporateCustomersOperationClaims.Admin, Write, CorporateCustomersOperationClaims.Update };
        ...
        UpdatedCorporateCustomerResponse>
    {
        ...
        public async Task<UpdatedCorporateCustomerResponse> Handle(UpdateCorporateCustomerCommand request,
                                                              CancellationToken cancellationToken)
        {
            ...
            UpdatedCorporateCustomerResponse updatedCorporateCustomerDto =
                _mapper.Map<UpdatedCorporateCustomerResponse>(updatedCorporateCustomer);
