...
public class CorporateCustomerBusinessRules
{
    ...
    public async Task CorporateCustomerIdShouldExistWhenSelected(int id)
    {
        ...
        if (result == null) throw new BusinessException(CorporateCustomerExceptionMessages.CorporateCustomerNotExistsMessage);
    }

    public Task CorporateCustomerShouldBeExist(CorporateCustomer corporateCustomer)
    {
        if (corporateCustomer is null) throw new BusinessException(CorporateCustomerExceptionMessages.CorporateCustomerNotExistsMessage);
    ...
    public async Task CorporateCustomerTaxNoCanNotBeDuplicatedWhenInserted(string taxNo)
    {
        ...
        if (result.Items.Any()) throw new BusinessException(CorporateCustomerExceptionMessages.CorporateCustomerTaxNoExistsMessage);
    }
}