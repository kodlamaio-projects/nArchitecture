...
public class CreateAdditionalServiceCommand : IRequest<CreatedAdditionalServiceResponse>, ISecuredRequest
{
    ...
    public string[] Roles => new[] { Domain.Constants.OperationClaims.Admin, AdditionalServicesOperationClaims.Admin, Write, Add };
            ...
            CreatedAdditionalServiceResponse>
    {
        ...
        public async Task<CreatedAdditionalServiceResponse> Handle(CreateAdditionalServiceCommand request,
                                                              CancellationToken cancellationToken)
        {
            ...
            CreatedAdditionalServiceResponse createdAdditionalServiceResponse =
                _mapper.Map<CreatedAdditionalServiceResponse>(createdAdditionalService);
