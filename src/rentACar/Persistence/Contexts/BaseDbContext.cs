...
public class BaseDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new CarDamageConfiguration());
        ...
        modelBuilder.ApplyConfiguration(new FindeksCreditRateConfiguration());
        ...
        modelBuilder.ApplyConfiguration(new RentalsAdditionalServiceConfiguration());
        modelBuilder.ApplyConfiguration(new RentalBranchConfiguration());
